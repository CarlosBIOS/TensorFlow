...
def evaluate_preds(y_true, y_pred):
  ...
  if mae.result().ndim > 0: # if mae isn't already a scalar, reduce it to one by aggregating tensors to mean
...
def make_windows(x, window_size: int = 7, horizon: int = 1) -> tuple:
